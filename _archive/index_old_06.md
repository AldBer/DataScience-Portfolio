...
## 3. Projetos SQL e Business Intelligence

### Semana 01 – Primeiros Passos com SQL

**Atividades:**
- Importação de base de imóveis reais (São Paulo)
- Criação da estrutura de banco de dados
- Primeiros comandos SQL: `SELECT`, `WHERE`, `ORDER BY`, `LIMIT`

📁 [Ver Projeto](03_SQL-BI-Projects/Semana_01/)  
🗃️ Base: `sp_properties_sample.csv`  
📄 Script: `queries_basicas_01.sql`
...
**Atividades:**
- Funções agregadas: `AVG`, `SUM`, `COUNT`, `ROUND`
- Agrupamentos com `GROUP BY` e filtros com `HAVING`
- Exportação dos dados para Power BI
- Criação de dashboard com indicadores e mapa georreferenciado

📁 [Ver Projeto](03_SQL-BI-Projects/Semana_02/)  
📄 Script: `queries_basicas_02.sql`  
📊 Dashboard: [`sp_kpis_dashboard.pbix`](03_SQL-BI-Projects/Semana_02/sp_kpis_dashboard.pbix)
